...
<div class="col-lg-12">	
    ...
    <div class="col-md-8">
    			...
    			<li class="list-group-item" data-id="<?php echo $row['id'] ?>" data-price="<?php echo $row['price'] ?>">
    				<div class="d-flex w-100">
    					...
    					<div class="detail-field">
    						<p>Nama Produk: <b><?php echo $row['pname'] ?></b></p>
    						<p>Harga: <b>Rp. <?php echo number_format($row['price'],2) ?></b></p>
    						<p>Rasa: <b><?php echo $size ?></b></p>
    						<p>Kemasan: <b><?php echo $colour ?></b></p>
    					...
    					<div class="amount-field">
    						<p>Total: <b class="amount">Rp. <?php echo number_format($row['qty']*$row['price'],2) ?></b></p>
    					</div>
    	...
    	<?php else: ?>
    		<center><b>Keranjang Kosong</b></center>
    	<?php endif; ?>
    </div>
    <div class="col-md-4">
    	<div class="card mb-4">
    		<div class="card-header bg-primary text-white"><b>Total Jumlah</b></div>
    		<div class="card-body">
    			<h4 class="text-right"><b id="tamount">Rp. <?php echo number_format($total,2) ?></b></h4>
    		</div>
    	</div>
...
<script>
	$('.btn-minus').click(function(){
     ...
     $('.rem_item').click(function(){
     	_conf("Apakah anda yakin ingin menghapus isi keranjang?","delete_cart",[$(this).attr('data-id')])
     })
     function delete_cart($id){
     	...
     	$.ajax({
        	...
        	success:function(resp){
        		if(resp == 1){
            		alert_toast("Item Berhasil Dihapus","success");
