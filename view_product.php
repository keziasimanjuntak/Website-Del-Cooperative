        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              ...
              <p>Kategori: <?php echo ucwords($cname) ?></p>

              <hr>
              <h4>Varian Rasa/Warna</h4>
              <?php 
          ...
          <div class="row mt-4">
            <nav class="w-100">
              <div class="nav nav-tabs" id="product-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="product-comments-tab" data-toggle="tab" href="#product-cat-desc" role="tab" aria-controls="product-cat-desc" aria-selected="false">Deskripsi Kategori</a>
              </div>
            </nav>
      ...
      $('#add_to_cart').click(function(){
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp == 1){
                    alert_toast("Item Berhasil Ditambahkan Ke Keranjang.","success")
                    end_load()
                    load_cart()
                }
            }
