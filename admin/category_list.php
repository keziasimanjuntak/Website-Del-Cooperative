	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_category"><i class="fa fa-plus"></i> Tambah Kategori</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	_conf("Apakah Anda Ingin Menghapus Produk Ini??","delete_category",[$(this).attr('data-id')])
	})
	})
