			...
			<table class="table table-hover table-bordered">
				<thead>
					<tr>
						...
						<th class="text-center">Tanggal Dipesan</th>
						<th class="text-center">Kode Pesanan</th>
						<th class="text-center">Tempat Pengiriman</th>
...
<script>
	$(document).ready(function(){
		...
		$('.view_order').click(function(){
			uni_modal("Pesanan "+$(this).attr('data-code'),"view_order.php?id="+$(this).attr('data-id'),"large")
		})
		$('.update_order').click(function(){
			uni_modal("Update Status Pesanan "+$(this).attr('data-code')+' ',"manage_order.php?id="+$(this).attr('data-id'))
		})
		$('.delete_order').click(function(){
		_conf("Apakah Anda Yakin Ingin Menghapus Pesanan Ini?","delete_order",[$(this).attr('data-id')])
		})
	})
